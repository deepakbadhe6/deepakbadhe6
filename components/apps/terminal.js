...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["deepakbadhe6-personal-portfolio", "Drive-Your-car"],
            interests: ["Software Development", "Web Development", "Data Structure"],
            languages: ["Core Java", "C++", "Java", "C"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">Deepak@Dell</div>
